...
RecorderUI.prototype.set_stopped = function() {
  ...
  e = document.getElementById("bdoc");
  e.style.display = 'none';
  e = document.getElementById("bexporttestlink")
	e.style.display = '';  
...
RecorderUI.prototype.export = function(options) {
  if(options && options.xy) {
    ...
    chrome.tabs.create({url: "./testStep.html"});
  }
}
RecorderUI.prototype.exportdoc = function(bexport) {
    chrome.tabs.create({url: "./doc.html"});
}
RecorderUI.prototype.exportTestLink = function(){
	chrome.tabs.create({url: "./exportTestLink.html"});
}
...
window.onload = function(){
    ...
    document.querySelector('input#bexporttestlink').onclick=function() {ui.exportTestLink();return false;};
